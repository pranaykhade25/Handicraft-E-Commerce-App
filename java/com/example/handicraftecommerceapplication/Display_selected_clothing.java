...
public class Display_selected_clothing extends AppCompatActivity {
    ImageView pots;
    TextView txt1;
    TextView txt2;
    Button buynow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_selected_clothing);
        ...
        buynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Display_selected_clothing.this, paymentdetails.class);

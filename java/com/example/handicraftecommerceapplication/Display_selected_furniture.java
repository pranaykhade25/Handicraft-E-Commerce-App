...
public class Display_selected_furniture extends AppCompatActivity {
    ImageView pots;
    TextView txt1;
    TextView txt2;
    Button buynow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_selected_furniture);
        ...
        buynow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Display_selected_furniture.this, paymentdetails.class);

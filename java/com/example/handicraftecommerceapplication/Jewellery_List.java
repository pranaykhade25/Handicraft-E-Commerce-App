...
public class Jewellery_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance().getReference("Product_Jewellery");
        ...
        db.collection("Product_Jewellery").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>()
                {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots)
                    {
                        if (!queryDocumentSnapshots.isEmpty())
                        {
                            ...
                            Toast.makeText(Jewellery_List.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Jewellery_List.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
